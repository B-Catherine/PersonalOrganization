...
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\PersonalEvent", mappedBy="users")
     */
    ...
    {
        if ($this->personalEvents->contains($personalEvent)) {
            $this->personalEvents->removeElement($personalEvent);
            // set the owning side to null (unless already changed)
            if ($personalEvent->getUsers() === $this) {
                $personalEvent->setUsers(null);
            }
        }
